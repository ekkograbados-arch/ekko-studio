...
if (typeof window !== "undefined") {
    // Exponer APIs para auditoría de ekkoDiagnostics
    window.alignSelection = alignSelection;
    window.centerSelection = centerSelection;
    window.distributeSpacing = distributeSpacing;
    window.syncGeomBaseDeep = syncGeomBaseDeep;
    window.initProControls = initProControls;
